...
import { DimensionLine } from '../components/TechnicalGraphics';

export function Contact() {
  const [showContent, setShowContent] = useState(false);

  return (
    <div className="max-w-2xl mx-auto space-y-12 animate-fade-in relative pb-20">
      ...
      <div className={`transition-all duration-500 ease-out ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 relative">
            {/* Decorative Line */}
            <div className="absolute left-1/2 top-8 -translate-x-1/2 hidden md:block opacity-20 rotate-90 origin-left">
              <DimensionLine width={150} />
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col space-y-4">
                ...
                >
                  ...
                  <span className="hover:underline decoration-1 underline-offset-4">Book a meeting</span>
                </a>
              </div>
            </div>
